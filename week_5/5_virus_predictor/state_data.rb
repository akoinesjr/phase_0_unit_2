...
#This hash contains the population density, current population, region number, and regional spread
#number (which tells where the virus will go next) for each state.
